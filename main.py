...
def update_author(author_id: str, name: str = None, address: str = None, age: int = None):
    ...
    if author:
        ...
        if age:
            author["age"] = age
        authors_collection.update_one({"_id": author_id}, {"$set": author})
...
def delete_author(author_id: str):
    result = authors_collection.delete_one({"_id": author_id})
...
def update_book(book_id: str, name: str = None, author: str = None, genre: str = None, published_date: str = None):
    ...
    if book:
        ...
        books_collection.update_one({"_id": book_id}, {"$set": book})
...
def seed_data():
    ...
    reviews = [
        Review("book_id_1", "Reviewer 1", 5, "Great book!"),
        Review("book_id_1", "Reviewer 2", 4, "Enjoyed reading it."),
    ]
